    ...
    <section className={styles["main-container"]}>
      <Container fluid>
        <div className={styles["main-header"]}>
          <h1 className={styles["header"]}> Transformación Digital</h1>
          <h5 className={styles["secondary-header"]}>¿En qué etapa de la transformación digital se encuentra tu empresa?</h5>
        </div>
